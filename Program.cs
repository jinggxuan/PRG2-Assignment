...
void ProcessUnassignedFlights(Dictionary<string, Flight> flights, Dictionary<string, BoardingGate> boardingGates, Dictionary<string, Airline> airlines, Dictionary<string, string> gateAssignments)
{
    ...
    while (flightQueue.Count > 0)
    {
        ...
        if (assignedGate != null)
        {
            ...
            // Add the gate assignment to the dictionary
            gateAssignments[currentFlight.FlightNumber] = assignedGate.GateName;
        ...
        if (int.TryParse(input, out option))
        {
            switch (option)
            {
                ...
                case 8:
                    ...
                    ProcessUnassignedFlights(terminal.Flights, terminal.BoardingGates, terminal.Airlines, gateAssignments);
                    break;
